...
public class PathAdapter {
    ...
    private static Translation2d getRedGearPosition() {
        ...
        Translation2d robotOffset = new Translation2d(kRedPegHeading.cos() * kRearDist, kRedPegHeading.sin() * kRearDist);
        return pegPosition.translateBy(robotOffset);
    }
    
    public static RigidTransform2d getRedStartPose() {
        return new RigidTransform2d(new Translation2d(Constants.kCenterToFrontBumperDistance, kFieldHeight/2 - kRedCenterToBoiler + Constants.kCenterToSideBumperDistance), kStartHeading);
    }
    ...
    private static Translation2d getBlueGearPosition() {
        ...
        Translation2d robotOffset = new Translation2d(kBluePegHeading.cos() * kRearDist, kBluePegHeading.sin() * kRearDist);
        return pegPosition.translateBy(robotOffset);
    }
    
    public static RigidTransform2d getBlueStartPose() {
        return new RigidTransform2d(new Translation2d(Constants.kCenterToFrontBumperDistance, kFieldHeight / 2 + kBlueCenterToBoiler - Constants.kCenterToSideBumperDistance), kStartHeading);
    }
