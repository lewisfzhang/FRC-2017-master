...
public class GearToCenterBlue implements PathContainer {

    @Override
    public Path buildPath() {
        ArrayList<Waypoint> sWaypoints = new ArrayList<Waypoint>();
        sWaypoints.add(new Waypoint(114,214,0,0));
        sWaypoints.add(new Waypoint(80,265,24,60));
        sWaypoints.add(new Waypoint(50,254,0,60));
